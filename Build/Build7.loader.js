function createUnityInstance(e, t, r) {
    ...
    function i(e) {
        return new Promise(function(t, r) {
            ...
            n.open("GET", l[e]), n.responseType = "arraybuffer", n.addEventListener("progress", function(t) {
                s(e, t)
    ...
    }), window.addEventListener("error", n), window.addEventListener("unhandledrejection", n);
    var p = {
        Module: l,
        ...
        Quit: function() {
            return new Promise(function(t, r) {
                l.shouldQuit = !0, l.onQuit = t, f.forEach(function(t) {
                    e.removeEventListener(t, o)
                }), window.removeEventListener("error", n), window.removeEventListener("unhandledrejection", n)
            })
        }
    };
    return l.SystemInfo = function() {
        ...
        function a(t) {
            this.cache = {
                ...
                var t = this.xhr,
                    r = this.cache;
                r.enabled && !r.revalidated && (304 == t.status ? (r.result.revalidated = r.result.accessed, r.revalidated = !0, u.execute(i.name, "put", [r.result]), e("'" + r.result.url + "' successfully revalidated and served from the indexedDB cache")) : 200 == t.status ? (r.result = o(r.result.url, r.company, r.product, r.result.accessed, t), r.revalidated = !0, u.execute(i.name, "put", [r.result], function(t) {
        ...
        a.prototype.send = function(t) {
            var n = this.xhr,
                o = this.cache,
                a = arguments;
            return o.enabled = o.enabled && "arraybuffer" == n.responseType && !t, o.enabled ? void u.execute(i.name, "get", [o.result.url], function(t) {
                if (!t || t.version != i.version) return void n.send.apply(n, a);
                if (o.result = t, o.result.accessed = Date.now(), "immutable" == o.control) o.revalidated = !0, u.execute(i.name, "put", [o.result]), n.dispatchEvent(new Event("load")), e("'" + o.result.url + "' served from the indexedDB cache without revalidation");
                    ...
                    s.open("HEAD", o.result.url), s.onload = function() {
                        ...
                        }), o.revalidated ? (o.result.revalidated = o.result.accessed, u.execute(i.name, "put", [o.result]), n.dispatchEvent(new Event("load")), e("'" + o.result.url + "' successfully revalidated and served from the indexedDB cache")) : n.send.apply(n, a)
                    }, s.send()
        ...
        for (var c in l) a.prototype.hasOwnProperty(c) || ! function(e) {
